...
if (!args[0]) throw `✳️Tiktok සබැඳිය ඇතුළු කරන්න\n\n 📌 උදාහරණය : ${usedPrefix + command} https://vm.tiktok.com/ZGJAmhSrpps/`
if (!args[0].match(/tiktok/gi)) throw `❎ ලින්ක් එක ටික්ටොක් එකෙන්ද බලන්න`
...
└───────────`
    ...
    if (!url) throw '❎වීඩියෝව බාගැනීමේ දෝෂයකි '
    let tex = `
┌─⊷ SERVER 2 
...
conn.sendFile(m.chat, url, 'tt.mp4', tex, m)
    ...
    m.reply(`❎වීඩියෝව බාගැනීමේ දෝෂයකි `)
}
} 
